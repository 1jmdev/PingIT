...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          "rounded-sm! top-1/3 translate-y-0 overflow-hidden p-0",
          className
        )}
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-input/30 border-input/30 h-8! rounded-sm! shadow-none! *:data-[slot=input-group-addon]:pl-2!">
